...
from .constants import (
    ...
    STEALTH_LOGS,
    STEALTH_PROXIES,
    STEALTH_PROXY_CIRCUIT_AFTER,
    STEALTH_PROXY_CIRCUIT_CODES,
    STEALTH_PROXY_COOLDOWN_S,
    STEALTH_PROXY_HEALTH,
...
class StealthConfig:
    ...
    STEALTH_CDP_URL: str | None = STEALTH_CDP_URL
    STEALTH_CDP_CONNECT_KWARGS: dict[str, Any] = dict(STEALTH_CDP_CONNECT_KWARGS)
    ...
    STEALTH_PROXY_HEALTH: bool = STEALTH_PROXY_HEALTH
    STEALTH_PROXY_CIRCUIT_AFTER: int = STEALTH_PROXY_CIRCUIT_AFTER
    STEALTH_PROXY_COOLDOWN_S: float = STEALTH_PROXY_COOLDOWN_S
    STEALTH_PROXY_CIRCUIT_CODES: frozenset[int] = STEALTH_PROXY_CIRCUIT_CODES
    STEALTH_LOGS: bool = STEALTH_LOGS
